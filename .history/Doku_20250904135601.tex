...
Jede Komponente sollte eine klar definierte Aufgabe haben. Beispielsweise übernimmt die HAL ausschließlich hardwarenahe Funktionen, während die Applikation die Logik steuert.
Die Software wird typischerweise in Applikation, Treiber und Hardwareabstraktion (HAL) unterteilt. Diese Trennung fördert Wiederverwendbarkeit und Testbarkeit.
Die Architektur sollte so gestaltet sein, dass Unit-Tests auf Host und Target möglich sind. Dazu gehören Mocking-Fähigkeit und lose Kopplung.
